    ...
    return (
      <div className={showHideClassName} onClick={this.handleOutsideClick} role="presentation">
        <div className="share-modal-content" ref={(node) => { this.node = node; }}>
          <button type="button" onClick={hideShareModal} className="share-close-button">
            <svg className="share-close-icon" viewBox="0 0 24 24">
          ...
          <section>
            ...
            <div className="share-method-container">
              <div className="share-method-wrapper">
                ...
                <span className="vertically-center">Twitter</span>
              </div>
            </div>
            <div className="share-method-container">
              <div className="share-method-wrapper">
                ...
                <span className="vertically-center">Email</span>
              </div>
            </div>
            <div className="share-method-container">
              <div className="share-method-wrapper">
                ...
                <span className="vertically-center">Messenger</span>
              </div>
            </div>
            <div className="share-method-container">
              <div className="share-method-wrapper">
                ...
                <span className="vertically-center">Copy Link</span>
              </div>
            </div>
            <div className="share-method-container">
              <div className="share-method-wrapper">
